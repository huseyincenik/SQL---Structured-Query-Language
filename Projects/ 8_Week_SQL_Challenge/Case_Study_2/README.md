...
![Pizza Runner Image](https://8weeksqlchallenge.com/images/case-study-designs/2.png)
(Source: [Pizza Runner Case Study Source](https://8weeksqlchallenge.com/case-study-2/))

This project encompasses a SQL study conducted on Pizza Runner. Below are detailed descriptions and solved questions of the project.
