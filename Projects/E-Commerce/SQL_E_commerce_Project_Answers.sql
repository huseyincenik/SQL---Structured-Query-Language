...
SELECT
	...
	LEAD(order_date, 15) OVER(PARTITION BY cust_id ORDER BY order_date) [16_visit],
	LEAD(order_date, 16) OVER(PARTITION BY cust_id ORDER BY order_date) [17_visit],
	ROW_NUMBER() OVER(PARTITION BY YEAR(order_date), MONTH(order_date) ORDER BY order_date, cust_id) row_number_date
FROM
        [order].order_table
ORDER BY
	row_number_date
...
SELECT
	TOP 275 SUM([2009_January]) OVER() AS [2009_January],
	SUM([2009_February]) OVER() AS [2009_February],
	SUM([2009_March]) OVER() AS [2009_March],
	SUM([2009_April]) OVER() AS [2009_April],
	SUM([2009_May]) OVER() AS [2009_May],
	SUM([2009_June]) OVER() AS [2009_June],
	SUM([2009_July]) OVER() AS [2009_July],
	SUM([2009_August]) OVER() AS [2009_August],
	SUM([2009_September]) OVER() AS [2009_September],
	SUM([2009_October]) OVER() AS [2009_October],
	SUM([2009_November]) OVER() AS [2009_November],
	SUM([2009_December]) OVER() AS [2009_December],
	SUM([2010_January]) OVER() AS [2010_January],
	SUM([2010_February]) OVER() AS [2010_February],
	SUM([2010_March]) OVER() AS [2010_March],
	SUM([2010_April]) OVER() AS [2010_April],
	SUM([2010_May]) OVER() AS [2010_May],
	SUM([2010_June]) OVER() AS [2010_June],
	SUM([2010_July]) OVER() AS [2010_July],
	SUM([2010_August]) OVER() AS [2010_August],
	SUM([2010_September]) OVER() AS [2010_September],
	SUM([2010_October]) OVER() AS [2010_October],
	SUM([2010_November]) OVER() AS [2010_November],
	SUM([2010_December]) OVER() AS [2010_December],
	SUM([2011_January]) OVER() AS [2011_January],
	SUM([2011_February]) OVER() AS [2011_February],
	SUM([2011_March]) OVER() AS [2011_March],
	SUM([2011_April]) OVER() AS [2011_April],
	SUM([2011_May]) OVER() AS [2011_May],
	SUM([2011_June]) OVER() AS [2011_June],
	SUM([2011_July]) OVER() AS [2011_July],
	SUM([2011_August]) OVER() AS [2011_August],
	SUM([2011_September]) OVER() AS [2011_September],
	SUM([2011_October]) OVER() AS [2011_October],
	SUM([2011_November]) OVER() AS [2011_November],
	SUM([2011_December]) OVER() AS [2011_December],
	SUM([2012_January]) OVER() AS [2012_January],
	SUM([2012_February]) OVER() AS [2012_February],
	SUM([2012_March]) OVER() AS [2012_March],
	SUM([2012_April]) OVER() AS [2012_April],
	SUM([2012_May]) OVER() AS [2012_May],
	SUM([2012_June]) OVER() AS [2012_June],
	SUM([2012_July]) OVER() AS [2012_July],
	SUM([2012_August]) OVER() AS [2012_August],
	SUM([2012_September]) OVER() AS [2012_September],
	SUM([2012_October]) OVER() AS [2012_October],
	SUM([2012_November]) OVER() AS [2012_November],
	SUM([2012_December]) OVER() AS [2012_December]
